  ...
  return (
    <Animated.View
      style={{
        ...
        borderBottomRightRadius: message.isMe ? theme.borderRadius.sm : theme.borderRadius.xl,
        borderBottomLeftRadius: message.isMe ? theme.borderRadius.xl : theme.borderRadius.sm,
